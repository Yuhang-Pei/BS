...
create table bs.scenario (
    ...
    foreign key (user_id) references bs.user(user_id)
);
...
create table bs.room (
    ...
    foreign key (scenario_id) references bs.scenario(scenario_id)
);
...
create table bs.device (
    ...
    device_x float,
    device_y float,
    foreign key (room_id) references bs.room(room_id)
);
...
create table bs.light (
    ...
    foreign key (light_id) references bs.device(device_id)
);
...
create table bs.lock (
    ...
    foreign key (lock_id) references bs.device(device_id)
);
...
create table bs.sensor (
    ...
    foreign key (sensor_id) references bs.device(device_id)
);
...
create table bs.switch (
    ...
    foreign key (switch_id) references bs.device(device_id)
);